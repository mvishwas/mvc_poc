...
*//**
 * A cache loader that loads Product entries from a backing store using a Spring
 * Data Repository
 * 
 ...
 *//*
@Component
public class ProductDBLoader implements CacheLoader<Long, EmployeeGemfire> {
	 ...
	 * 
	 * @see
	 * com.gemstone.gemfire.cache.CacheLoader#load(com.gemstone.gemfire.cache
	 * .LoaderHelper)
	 
	@Override
	public Product load(LoaderHelper<Long, Product> loadHelper)
